...
この記事では、次の数学的命題(予想)を提示し、その導出(※証明というほど厳密に書く力量がないので)を行います。
...
これはあきらかに`int`系列の冪集合と一対一に対応します。

[可算無限集合の冪集合は非可算無限集合](https://ja.wikipedia.org/wiki/%E3%82%AB%E3%83%B3%E3%83%88%E3%83%BC%E3%83%AB%E3%81%AE%E5%AE%9A%E7%90%86)なので、集合Sは非可算無限集合です。これが示したいことでした。
...
これにメソッド定義を追加して得られるのが最初に書いたインタフェースで、これの型集合はunionsの型集合よりも小さいです。
