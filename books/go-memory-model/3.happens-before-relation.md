...
![goroutine 1とgoroutine 2を抜き出した図](/images/hb-concurrent-example.png)
*goroutine 1とgoroutine 2の全体を抜き出したもの（枠の外に伸びる矢印は元のグラフの他の部分との接続を表す）。`[a = 1]`と`[print(a)]`の間には、どちらの向きにも矢印を辿る経路が存在しない*
